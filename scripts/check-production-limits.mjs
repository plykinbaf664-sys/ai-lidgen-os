...
assert.equal(leadgenProductionConfig.contactReadyTarget, 50);
...
console.log("PRODUCTION_LIMITS_OK discovery_pool=50 email_ready=50 contact_ready_quality_metric=50 initial_daily=100 initial_batch=50");
